...
export function SiteHeader({
  ...
  return (
    <header className="pointer-events-none fixed inset-x-0 top-0 z-[60] flex items-center justify-between gap-4 px-5 pt-[max(1.25rem,env(safe-area-inset-top))] pb-5 sm:px-8 sm:pt-[max(1.75rem,env(safe-area-inset-top))] sm:pb-7">
      <Logo tone={tone} className="pointer-events-auto relative z-10 inline-flex h-10 shrink-0 items-center leading-none" />
      <div className="pointer-events-auto flex h-10 min-w-0 items-center justify-end gap-3 sm:h-auto sm:flex-row sm:gap-5">
